...
using DynamicForms.Utils;
using DynamicForms.ViewModels;
using MvvmCross.Forms.Views;
using Xamarin.Forms;

namespace DynamicForms.View
{
    public class DynamicPage : MvxContentPage<DynamicPageViewModel>
    {
        /// <summary>
        ...
        /// </summary>
        UIUtilities<DynamicPageViewModel> uIUtilities;
        ...
        public DynamicPage()
        {
            ...
            ViewModel = BindingContext.DataContext as DynamicPageViewModel; // binding the viewmodel's context
        }
        ...
        private void LoadPageSettings()
        {
            if (_isInitialLoad)
            {
                while (template == null) // wait till the data from api is getting loaded.
                {
                    ...
                    uIUtilities = new UIUtilities<DynamicPageViewModel>(ViewModel); // passing
                }
